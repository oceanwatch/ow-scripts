...
nc=nc_open('2021/chl-Wake-1998-2019-mean.nc')
v1=nc$var[[1]]
...
#breaks=h$breaks
breaks=log(c(seq(0.04,0.056,0.00001),0.61))
n=length(breaks)-1
...
par(mar=c(3,1,3,4))
image.scale(clim, col=c, breaks=log(c(seq(0.04,0.056,0.00001),0.057)), horiz=FALSE,xlab='',ylab='',main='',las=1,yaxt='n')
axis(4,at=log(c(seq(0.04,0.056,0.002),0.057)),c(seq(0.04,0.056,0.002),0.61),las=1)
box()

##################################################################################################################################3
#anomaly

nc=nc_open('2021/chl-Wake-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(-0.41,seq(-0.015,0.015,0.0001),0.07)
n=length(breaks)-1
...
par(mar=c(3,0,3,4))
image.scale(anom, col=c, breaks=c(-0.017,seq(-0.015,0.015,0.0001),0.017), horiz=FALSE,xlab='',ylab='',main='',yaxt='n',las=1)
axis(4,at=c(-0.017,seq(-0.015,0.015,0.002),0.017),labels=round(c(-0.41,seq(-0.015,0.015,0.002),0.07),3),las=1)
box()



#time-series
nc=nc_open('2021/chl-Wake-1998-2020.nc')
v1=nc$var[[1]]
chl=ncvar_get(nc,v1)
