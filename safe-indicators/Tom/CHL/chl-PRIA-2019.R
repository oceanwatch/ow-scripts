...
nc=nc_open('2020/chl-PRIA-1998-2018-mean.nc')
v1=nc$var[[1]]
...
#breaks=h$breaks
breaks=log(c(seq(0.08,0.25,0.0001),1.8))
n=length(breaks)-1
...
axis(4,at=log(c(seq(0.08,0.25,0.02),0.26)),c(seq(0.08,0.25,0.02),1.8),las=1)
box()

##################################################################################################################################3
#anomaly

nc=nc_open('2020/chl-PRIA-2019-mean.nc')
v1=nc$var[[1]]
...
breaks=c(-1.2,seq(-0.05,0.05,0.0005),0.11)
n=length(breaks)-1
...
axis(4,at=c(-0.06,seq(-0.05,0.05,0.01),0.06),labels=c(-0.77,seq(-0.05,0.05,0.01),0.1),las=1)
box()



#time-series
nc=nc_open('2020/chl-PRIA-1998-2019.nc')
v1=nc$var[[1]]
chl=ncvar_get(nc,v1)
