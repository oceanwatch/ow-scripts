...
nc=nc_open('2021/chl-AS-1998-2019-mean.nc')
v1=nc$var[[1]]
...
#breaks=h$breaks
breaks=log(c(seq(0.03,0.13,0.0001),4.1))
n=length(breaks)-1
...
axis(4,at=c(log(c(seq(0.03,0.13,0.02),0.15))),c(seq(0.03,0.13,0.02),4.1),las=1)
box()

##################################################################################################################################3
#anomaly

nc=nc_open('2021/chl-AS-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(-3,seq(-0.05,0.05,0.0005),1.9)
n=length(breaks)-1
...
axis(4,at=c(-0.06,seq(-0.05,0.05,0.01),0.06),labels=c(-3.0,seq(-0.05,0.05,0.01),1.9),las=1)
#axis(4,las=1)
box()
...
#time-series
nc=nc_open('2021/chl-AS-1998-2020.nc')
v1=nc$var[[1]]
chl=ncvar_get(nc,v1)
