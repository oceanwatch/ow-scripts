...
nc=nc_open('2020/chl-Johnston-1998-2018-mean.nc')
v1=nc$var[[1]]
...
#breaks=h$breaks
breaks=log(c(seq(0.04,0.10,0.0001),0.5))
n=length(breaks)-1
...
axis(4,at=log(c(seq(0.04,0.1,0.01),0.11)),c(seq(0.04,0.1,0.01),0.38),las=1)
...
nc=nc_open('2020/chl-Johnston-2019-mean.nc')
v1=nc$var[[1]]
...
breaks=c(-0.11,seq(-0.01,0.01,0.00005),0.02)
n=length(breaks)-1
...
axis(4,at=c(-0.012,seq(-0.01,0.01,0.002),0.012),labels=c(-0.11,seq(-0.01,0.01,0.002),0.02),las=1)
#axis(4,las=1)
box()
...
#time-series
nc=nc_open('2020/chl-Johnston-1998-2019.nc')
v1=nc$var[[1]]
chl=ncvar_get(nc,v1)
