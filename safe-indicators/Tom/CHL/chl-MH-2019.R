...
nc=nc_open('2020/chl-MH-1998-2018-mean.nc')
v1=nc$var[[1]]
...
#breaks=h$breaks
breaks=log(c(seq(0.04,0.15,0.0001),0.58))
n=length(breaks)-1
...
par(mar=c(3,1,3,3))
image.scale(clim, col=c, breaks=log(c(seq(0.04,0.15,0.0001),0.17)), horiz=FALSE,xlab='',ylab='',main='',las=1,yaxt='n')
axis(4,at=log(c(seq(0.05,0.15,0.02),0.17)),c(seq(0.05,0.15,0.02),0.8),las=1)
box()

##################################################################################################################################3
#anomaly

nc=nc_open('2020/chl-MH-2019-mean.nc')
v1=nc$var[[1]]
...
breaks=c(-0.2,seq(-0.025,0.025,0.0005),1.26)
n=length(breaks)-1
...
axis(4,at=c(-0.03,seq(-0.025,0.025,0.01),0.03),labels=c(-0.2,seq(-0.025,0.025,0.01),1.26),las=1)
box()



#time-series
nc=nc_open('2020/chl-MH-1998-2019.nc')
v1=nc$var[[1]]
chl=ncvar_get(nc,v1)
