...
nc=nc_open('2021/sst-Johnston-1985-2019-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2021/sst-Johnston-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-0.27,-0.16,0.001),0,seq(0.16,0.27,0.001))
...
#time-series
nc=nc_open('2021/sst-Johnston-1985-2020.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2021/sst-Johnston-2003-2020-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
