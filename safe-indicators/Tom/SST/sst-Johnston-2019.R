...
nc=nc_open('2020/sst-Johnston-1985-2018-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2020/sst-Johnston-2019-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-0.65,-0.59,0.001),0,seq(0.59,0.65,0.001))
...
#time-series
nc=nc_open('2020/sst-Johnston-1985-2019.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
write.csv(T,'sst-CRW-Johnston.csv',row.names=TRUE)
...
nc=nc_open('2020/sst-Johnston-2003-2019-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
