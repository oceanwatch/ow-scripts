...
nc=nc_open('2021/sst-AS-1985-2019-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2021/sst-AS-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-0.7,-0.21,0.001),0,seq(0.21,0.7,0.001))
...
#time-series
nc=nc_open('2021/sst-AS-1985-2020.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2021/sst-AS-2003-2019-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
