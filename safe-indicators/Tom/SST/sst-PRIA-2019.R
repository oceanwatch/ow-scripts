...
nc=nc_open('2020/sst-PRIA-1985-2018-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2020/sst-PRIA-2019-mean.nc')
v1=nc$var[[1]]
...
#time-series
nc=nc_open('2020/sst-PRIA-1985-2019.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2020/sst-PRIA-2003-2019-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
