...
nc=nc_open('2020/sst-Mariana-1985-2018-mean.nc')
v1=nc$var[[1]]
...
x11(width=3.7,height=7.65)
layout(matrix(c(1,2,3,0,4,0), nrow=1, ncol=2), widths=c(2,1), heights=4)
layout.show(2)
...
nc=nc_open('2020/sst-Mariana-2019-mean.nc')
v1=nc$var[[1]]
sst_2019=ncvar_get(nc,v1)
lon=v1$dim[[1]]$vals
lat=v1$dim[[2]]$vals
...
breaks=c(seq(-0.56,-0.14,0.01),0,seq(0.14,0.56,0.01))
...
#time-series
nc=nc_open('2020/sst-Mariana-1985-2019.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
write.csv(T,'sst-CRW-Mariana.csv',row.names=TRUE)
...
nc=nc_open('2020/sst-Mariana-2003-2019-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
