...
nc=nc_open('2019/sst-LI-1982-2017-mean.nc')
v1=nc$var[[1]]
...
x11(width=4.54,height=6.39)
layout(matrix(c(1,2,3,0,4,0), nrow=1, ncol=2), widths=c(3,1), heights=4)
layout.show(2)
...
axis(2)
#axis(1)
axis(1,seq(197,201,1),seq(197,201,1)-360)
box()
...
nc=nc_open('2019/sst-LI-2018-mean.nc')
v1=nc$var[[1]]
...
#time-series
nc=nc_open('2019/sst-LI-1982-2018.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2019/sst-LI-2003-2018-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
