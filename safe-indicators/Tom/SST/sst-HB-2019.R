...
nc=nc_open('2019/sst-HB-1982-2017-mean.nc')
v1=nc$var[[1]]
...
axis(2)
#axis(1)
axis(1,seq(183,184,0.2),seq(183,184,0.2)-360)
box()
...
nc=nc_open('2019/sst-HB-2018-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-1.5,-0.5,0.01),0,seq(0.5,1.5,0.01))
...
#time-series
nc=nc_open('2019/sst-HB-1982-2018.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2019/sst-HB-2003-2018-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
