...
nc=nc_open('2021/sst-Wake-1985-2019-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2021/sst-Wake-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-0.23,-0.08,0.01),0,seq(0.08,0.23,0.01))
...
#time-series
nc=nc_open('2021/sst-Wake-1985-2020.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2021/sst-Wake-2003-2020-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
