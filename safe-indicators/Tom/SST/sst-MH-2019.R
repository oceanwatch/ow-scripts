...
nc=nc_open('2019/sst-MH-1982-2017-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2019/sst-MH-2018-mean.nc')
v1=nc$var[[1]]
...
#time-series
nc=nc_open('2019/sst-MH-1982-2018.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2019/sst-MH-2003-2018-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
