...
nc=nc_open('2021/sst-MH-1985-2019-mean.nc')
v1=nc$var[[1]]
...
nc=nc_open('2021/sst-MH-2020-mean.nc')
v1=nc$var[[1]]
...
breaks=c(seq(-0.76,-0.12,0.01),0,seq(0.12,0.76,0.01))
...
#time-series
nc=nc_open('2021/sst-MH-1985-2020.nc')
v1=nc$var[[1]]
sst=ncvar_get(nc,v1)
...
nc=nc_open('2021/sst-MH-2003-2020-gp.nc')
v1=nc$var[[1]]
gp=ncvar_get(nc,v1)
